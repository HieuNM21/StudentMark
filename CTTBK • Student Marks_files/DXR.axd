...
{
    background-image: url('/DXR.axd?r=0_2972-8l9Cr');
    height: 40px;
    width: 40px;
}
...
{
    content: url('/DXR.axd?r=0_2972-8l9Cr');
}
/* ASPxPictureEdit */
...
{
    background: url('/DXR.axd?r=0_2975-8l9Cr') repeat;
    font-size: 0;
    line-height: 0px;
}
...
{
    background-image: url('/DXR.axd?r=0_2971-8l9Cr');
...
.dxigItem_Mulberry
{
    background-repeat: no-repeat;
    background-position: center center;
    background-image: url('/DXR.axd?r=0_2969-8l9Cr');
}
.dxigItem_Mulberry a
{
    outline: 0;
...
{
    width: 43px;
    background: url('/DXR.axd?r=0_2970-8l9Cr') repeat-y;
}
.dxigControl_Mulberry .dxig-bottomPanel .dxis-nbBottom > .dxis-prevBtnHorWrapper
{
...
{
	background: url('/DXR.axd?r=1_94-Yk9Cr');
	height: 16px;
	width: 16px;
}
...
.dx-acc-r.dxlpLoadingPanelWithContent .dxlp-loadingImage {
    content: url('/DXR.axd?r=1_94-Yk9Cr');
}
.dxlpControl {
    cursor: default;
}
...
{
	background-image: url('/DXR.axd?r=1_101-Yk9Cr');
}
...
.dxpLite .dxp-dropDownButton
{
    ...
    background: #e6e6e6 url('/DXR.axd?r=1_111-Yk9Cr') repeat-x top;
    
}
.dxpLite .dxp-hoverDropDownButton
{
    border: 1px solid #606060;
    background: #f2f2f2 url('/DXR.axd?r=1_112-Yk9Cr') repeat-x top;
}
...
{
	background: #E8E7E8 url('/DXR.axd?r=1_120-Yk9Cr') repeat-x;
	border: 1px solid #7F7F7F;
	padding: 5px;
}
...
{
	background: #F4F4F4 url('/DXR.axd?r=1_121-Yk9Cr') repeat-x;
}
...
.dxtcLite > .dxtc-stripContainer .dxtc-sbDisabled
{
	cursor: default;
	border-color: #C3C3C3;
	background: #E6E7E8 url('/DXR.axd?r=1_122-Yk9Cr') repeat-x;
}
...
.dxucBrowseButton
{
	padding: 4px 8px 3px;
	border: 1px solid #7F7F7F;
	background: #E0DFDF url('/DXR.axd?r=1_133-Yk9Cr') repeat-x top;
}
...
{
	border: 1px solid #606060;
	background: #F2F2F2 url('/DXR.axd?r=1_134-Yk9Cr') repeat-x top;
}
...
{
	background: url('/DXR.axd?r=1_115-Yk9Cr') repeat;
	font-size: 0;
	line-height: 0px;
}
...
.dxtvControl .dxtv-ln
{
	background: url('/DXR.axd?r=1_116-Yk9Cr') repeat-y;
	vertical-align: top;
}
...
.dxtvControl .dxtv-elb
{
	background: url('/DXR.axd?r=1_117-Yk9Cr') no-repeat;
}
...
.dxtvControl.dxtvRtl .dxtv-elb
{
	background-image: url('/DXR.axd?r=1_118-Yk9Cr');
}
...
{
	width: 3px;
	background: url('/DXR.axd?r=1_123-Yk9Cr') repeat-y right;
	border-width: 0px;
}
...
{
    background-image: url('/DXR.axd?r=1_97-Yk9Cr');
    background-repeat: no-repeat;
    background-position:center center;
}
...
.dxigItem
{
    background-repeat: no-repeat;
    background-position:center center;
    background-image: url('/DXR.axd?r=1_98-Yk9Cr');
}
.dxigItem a
{
    outline: 0;
...
{
    width: 43px;
    background: url('/DXR.axd?r=1_99-Yk9Cr') repeat-y;
}
.dxigControl .dxig-bottomPanel .dxis-nbBottom > .dxis-prevBtnHorWrapper
{
    background-position: 0 0;
...
.dxrControl .dxtcLite.dxtc-top .dxr-fileTab {
    background: #e5e5e5 url('/DXR.axd?r=1_136-Yk9Cr') repeat-x;
    border-color: #a8a8a8;
    border-left-width: 1px;
    border-right-width: 1px;
}
.dxrControl .dxtcLite.dxtc-top .dxtc-tabHover.dxr-fileTab {
    background: #E8E7E8 url('/DXR.axd?r=1_137-Yk9Cr') repeat-x;
    border-color: #a8a8a8;
}
...
/* Color edit */
.dxcpColorAreaSys {
	background-image: url('/DXR.axd?r=1_176-Yk9Cr');
	position: relative;
	width: 290px;
	height: 240px;
	overflow: hidden;
...
.dxcpHueAreaImageSys {
	background-image: url('/DXR.axd?r=1_178-Yk9Cr');
	position: absolute;
	left: 6px;
	width: 21px;
    height: 240px;
...
.dxcpColorPointerSys {
	background-image: url('/DXR.axd?r=1_177-Yk9Cr');
	position: absolute;
	width: 11px;
	height: 11px;
}
.dxcpHuePointerSys {
	background-image: url('/DXR.axd?r=1_179-Yk9Cr');
	position: absolute;
	width: 35px;
	height: 9px;
}
...
{
	background-image:  url('/DXR.axd?r=1_164-Yk9Cr');
}
.dxeTBVSys .dxeTBTrack
{
	background-image:  url('/DXR.axd?r=1_163-Yk9Cr');
}
...
{
	background-image:  url('/DXR.axd?r=1_162-Yk9Cr');
}
.dxeTBVSys .dxeTBBarHighlight
{
	background-image:  url('/DXR.axd?r=1_161-Yk9Cr');
}
...
.dxeTBHSys .dxeTBItem
{
	background-image:  url('/DXR.axd?r=1_153-Yk9Cr');
}
.dxeTBHSys .dxeTBBScaleSys .dxeTBItem
{
	background-image:  url('/DXR.axd?r=1_158-Yk9Cr');
}
.dxeTBVSys .dxeTBItem 
{
	background-image:  url('/DXR.axd?r=1_156-Yk9Cr');
}
.dxeTBVSys .dxeTBBScaleSys .dxeTBItem
{
	background-image:  url('/DXR.axd?r=1_157-Yk9Cr');
}
...
{
	background-image: url('/DXR.axd?r=1_154-Yk9Cr');
}
.dxeTBVSys .dxeTBSmallTick
{
	background-image: url('/DXR.axd?r=1_155-Yk9Cr');
}
.dxeTBHSys .dxeTBBScaleSys .dxeTBLargeTick
{
	background-image: url('/DXR.axd?r=1_159-Yk9Cr');
}
.dxeTBVSys .dxeTBBScaleSys .dxeTBLargeTick
{
	background-image: url('/DXR.axd?r=1_160-Yk9Cr');
}
...
.dxeSpinLargeDecButton
{
	background: #e6e6e6 url('/DXR.axd?r=1_173-Yk9Cr') repeat-x top;
}
.dxeSpinIncButton
{
	background: #F0F0F0 url('/DXR.axd?r=1_169-Yk9Cr') repeat-x top;
}
.dxeSpinDecButton
{
	background: #E6E6E6 url('/DXR.axd?r=1_170-Yk9Cr') repeat-x top;
}
.dxeCalendarButton,
.dxeColorEditButton
{
	background: #e5e5e5 url('/DXR.axd?r=1_171-Yk9Cr') repeat-x top;
...
{
	background: #F2F2F2 url('/DXR.axd?r=1_174-Yk9Cr') repeat-x top;
	border: 1px Solid #606060;
}
.dxeSpinIncButtonHover
{
...
{
	background: #F2F2F2 url('/DXR.axd?r=1_172-Yk9Cr') repeat-x top;
}
.dxeCalendarButtonHover,
.dxeColorEditButton:hover
{
...
.dxbButton
{
	...
	font: 12px Tahoma, Geneva, sans-serif;
	border: 1px solid #7F7F7F;
	background: #E0DFDF url('/DXR.axd?r=1_167-Yk9Cr') repeat-x top;
	padding: 1px;
}
.dxbButtonHover
{
	color: #000000;
	background: #F2F2F2 url('/DXR.axd?r=1_168-Yk9Cr') repeat-x top;
	border: 1px solid #606060;
}
.dxbButtonChecked
{
...
{
    background: url('/DXR.axd?r=1_90-Yk9Cr') no-repeat;
    float: left;
    height: 21px;
    vertical-align: top;
    width: 26px;
...
{
    background: url('/DXR.axd?r=1_91-Yk9Cr') no-repeat;
    float: right;
	margin-right: 0;
    margin-left: 0.3em;
...
.dxfcControl .dxfc-ln
{
    background: url('/DXR.axd?r=1_89-Yk9Cr') repeat-y;
    vertical-align: top;
}
...
{
	background-image: url('/DXR.axd?r=1_94-Yk9Cr');
	height: 16px;
	width: 16px;
}
.dxpcLite .dxHFBPS
...
.dxeToken {
	background: #ececec url('/DXR.axd?r=1_175-Yk9Cr') repeat-x top;
}
